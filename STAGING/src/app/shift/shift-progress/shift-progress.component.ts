...
export class ShiftProgressComponent extends SmartComponent implements OnInit {
  ...
  get startTimestamp(): number {
    return this.shift.startTime && this.shift.startTime.getTime ? this.shift.startTime.getTime() : 0;
  }

  get endTimestamp(): number {
    return this.shift.endTime && this.shift.endTime.getTime ? this.shift.endTime.getTime() : 0;
  }
