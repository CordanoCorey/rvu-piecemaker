    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            Hrresult = table.Column<int>(nullable: true),
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      ...
                      onDelete: ReferentialAction.Restrict);
            table.ForeignKey(
                      name: "FK_Tag_LastModifiedByUser",
                      column: x => x.LastModifiedById,
                      principalSchema: "Auth",
                      principalTable: "User",
                      principalColumn: "Id",
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("PK_ExamTag_xref", x => x.Id);
            table.ForeignKey(
                      name: "FK_ExamTag_xref_ExamType",
                      column: x => x.ExamTypeId,
                      principalSchema: "Common",
                      principalTable: "ExamType",
                      principalColumn: "Id",
      ...
      migrationBuilder.InsertData(
          ...
          values: new object[,]
          {
                    { 1, 0, "f605120f-716d-40c3-9dbd-8ff473410823", null, "gelbaughcm@gmail.com", false, "System", "Administrator", false, null, "GELBAUGHCM@GMAIL.COM", "GELBAUGHCM@GMAIL.COM", "AQAAAAEAACcQAAAAEOArtYDjNhZZ70ALB8gN48bBCYBvnHqlujqi9YvoQLZheFnvqYIS0X9xI3BHGchHdg==", null, null, false, 33.3m, "dfafd561-8cef-40ad-8c7a-339dc67529d0", 1, false, "gelbaughcm@gmail.com", 1 },
                    { 2, 0, "b39b7fd6-391c-4d74-ae0c-14a75b78866d", 1, "dmartingrad@gmail.com", false, "Doug", "Martin", false, null, "DMARTINGRAD@GMAIL.COM", "DMARTINGRAD@GMAIL.COM", "AQAAAAEAACcQAAAAEOArtYDjNhZZ70ALB8gN48bBCYBvnHqlujqi9YvoQLZheFnvqYIS0X9xI3BHGchHdg==", null, null, false, null, "YSMHWI6B5ZHJFY4JDYXCHTUO52NXZWXB", 1, false, "dmartingrad@gmail.com", 1 },
                    { 3, 0, "8162aab4-994a-4a36-b184-867c083484c3", 1, "pspotok@verizon.net", false, "Paul", "Potok", false, null, "PSPOTOK@VERIZON.NET", "PSPOTOK@VERIZON.NET", "AQAAAAEAACcQAAAAEOArtYDjNhZZ70ALB8gN48bBCYBvnHqlujqi9YvoQLZheFnvqYIS0X9xI3BHGchHdg==", null, null, false, null, "MKZ5DGRD44RCRJFUGZTIYTWZJ2IXSHUE", 1, false, "pspotok@verizon.net", 1 }
          });
      ...
      migrationBuilder.InsertData(
          ...
          values: new object[] { 1, 1, new DateTime(2019, 9, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 100000m, 1, new DateTime(2019, 9, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1 });
      ...
      migrationBuilder.CreateIndex(
          name: "IX_ExamTag_xref_ExamTypeId",
          schema: "Common",
          table: "ExamTag_xref",
          column: "ExamTypeId");

      migrationBuilder.CreateIndex(
          name: "IX_ExamTag_xref_TagId",
          schema: "Common",
          table: "ExamTag_xref",
          column: "TagId");
