...
import { FormsModule, TimeModule, AccordionModule } from '@caiu/library';
...
@NgModule({
  ...
  exports: [CalendarComponent, CalendarDayComponent, CalendarDaysComponent, CalendarEventComponent],
  entryComponents: [CalendarDayEditComponent, CalendarFormComponent, CalendarEventFormComponent]
})
