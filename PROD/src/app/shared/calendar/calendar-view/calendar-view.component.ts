import { Component, OnInit, Input, ElementRef, ViewChild, ChangeDetectionStrategy, TemplateRef, Output, EventEmitter } from '@angular/core';
import { MatDialog } from '@angular/material';
import { DumbComponent, DateHelper } from '@caiu/library';

import { CalendarDay, CalendarEvent, CalendarEventType } from '../calendar.model';
